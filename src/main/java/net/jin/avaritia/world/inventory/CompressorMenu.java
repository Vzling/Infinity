...
public class CompressorMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CompressorMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(AvaritiaModMenus.COMPRESSOR.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 35, 35) {
