...
import net.jin.avaritia.procedures.ScaleAndKillProcedure;
import net.jin.avaritia.procedures.AttractEntityProcedure;
...
public class BlackHoleEntity extends PathfinderMob implements GeoEntity {
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		ScaleAndKillProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		AttractEntityProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
	...
	private PlayState movementPredicate(AnimationState event) {
		if (this.animationprocedure.equals("empty")) {
			return event.setAndContinue(RawAnimation.begin().thenLoop("animation.model.big"));
		}
